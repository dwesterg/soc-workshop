 ...
 */
#define WR_DESCRIPTOR_READ_ADDRESS(base, data)           *(unsigned long *)(base+ DESCRIPTOR_READ_ADDRESS_REG)= data
#define WR_DESCRIPTOR_WRITE_ADDRESS(base, data)          *(unsigned long *)(base+ DESCRIPTOR_WRITE_ADDRESS_REG)= data
#define WR_DESCRIPTOR_LENGTH(base, data)                 *(unsigned long *)(base+ DESCRIPTOR_LENGTH_REG)= data
#define WR_DESCRIPTOR_CONTROL_STANDARD(base, data)       *(unsigned long *)(base+ DESCRIPTOR_CONTROL_STANDARD_REG)= data   // this pushes the descriptor into the read/write FIFOs when standard descriptors are used
#define WR_DESCRIPTOR_SEQUENCE_NUMBER(base, data)        *(unsigned short *)(base+ DESCRIPTOR_SEQUENCE_NUMBER_REG)= data
#define WR_DESCRIPTOR_READ_BURST(base, data)             *(unsigned char *)(base+ DESCRIPTOR_READ_BURST_REG)= data
#define WR_DESCRIPTOR_WRITE_BURST(base, data)            *(unsigned char *)(base+ DESCRIPTOR_WRITE_BURST_REG)= data
#define WR_DESCRIPTOR_READ_STRIDE(base, data)            *(unsigned short *)(base+ DESCRIPTOR_READ_STRIDE_REG)= data
#define WR_DESCRIPTOR_WRITE_STRIDE(base, data)           *(unsigned short *)(base+ DESCRIPTOR_WRITE_STRIDE_REG)= data
#define WR_DESCRIPTOR_READ_ADDRESS_HIGH(base, data)      *(unsigned long *)(base+ DESCRIPTOR_READ_ADDRESS_HIGH_REG)= data
#define WR_DESCRIPTOR_WRITE_ADDRESS_HIGH(base, data)     *(unsigned long *)(base+ DESCRIPTOR_WRITE_ADDRESS_HIGH_REG)= data
#define WR_DESCRIPTOR_CONTROL_ENHANCED(base, data)       *(unsigned long *)(base+ DESCRIPTOR_CONTROL_ENHANCED_REG)= data   // this pushes the descriptor into the read/write FIFOs when the extended descriptors are used
