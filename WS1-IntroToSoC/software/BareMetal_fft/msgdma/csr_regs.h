...
#define WR_CSR_STATUS(base, data)              alt_write_word((base+ CSR_STATUS_REG), data)
#define WR_CSR_CONTROL(base, data)             alt_write_word((base+ CSR_CONTROL_REG), data)
#define RD_CSR_STATUS(base)                    alt_read_word(base+ CSR_STATUS_REG)
#define RD_CSR_CONTROL(base)                   alt_read_word(base+ CSR_CONTROL_REG)
#define RD_CSR_DESCRIPTOR_FILL_LEVEL(base)     alt_read_word(base+ CSR_DESCRIPTOR_FILL_LEVEL_REG)
#define RD_CSR_RESPONSE_FILL_LEVEL(base)       alt_read_word(base+ CSR_RESPONSE_FILL_LEVEL_REG)
#define RD_CSR_SEQUENCE_NUMBER(base)           alt_read_word(base+ CSR_SEQUENCE_NUMBER_REG)
