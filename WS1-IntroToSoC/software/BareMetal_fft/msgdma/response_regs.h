...
#define RD_RESPONSE_ACTUAL_BYTES_TRANSFFERED(base)     alt_read_word(base + RESPONSE_ACTUAL_BYTES_TRANSFERRED_REG)
#define RD_RESPONSE_ERRORS_REG(base)                   alt_read_word(base + RESPONSE_ERRORS_REG)
