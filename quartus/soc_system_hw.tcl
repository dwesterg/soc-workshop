...
proc compose { } {
    ...
    add_instance hps_0 altera_hps 14.0
    ...
    add_instance dipsw_pio altera_avalon_pio 14.0
    ...
    add_instance intr_capturer_0 intr_capturer 1.0
    ...
    add_connection hps_0.h2f_lw_axi_master led_pio.s1 avalon
    ...
    add_connection hps_0.h2f_lw_axi_master dipsw_pio.s1 avalon
    ...
    add_connection hps_0.h2f_lw_axi_master button_pio.s1 avalon
    ...
    set_connection_parameter_value intr_capturer_0.interrupt_receiver/dipsw_pio.irq irqNumber {0}

    add_connection intr_capturer_0.interrupt_receiver jtag_uart.irq interrupt
    set_connection_parameter_value intr_capturer_0.interrupt_receiver/jtag_uart.irq irqNumber {2}
    ...
    add_connection fpga_only_master.master intr_capturer_0.avalon_slave_0 avalon
    set_connection_parameter_value fpga_only_master.master/intr_capturer_0.avalon_slave_0 arbitrationPriority {1}
    set_connection_parameter_value fpga_only_master.master/intr_capturer_0.avalon_slave_0 baseAddress {0x00030000}
    set_connection_parameter_value fpga_only_master.master/intr_capturer_0.avalon_slave_0 defaultConnection {0}
    ...
    set_interconnect_requirement {mm_interconnect_0|cmd_mux_005.src/onchip_memory2_0_s1_burst_adapter.sink0} {qsys_mm.postTransform.pipelineCount} {1}
    set_interconnect_requirement {mm_interconnect_0|onchip_memory2_0_s1_burst_adapter.source0/onchip_memory2_0_s1_agent.cp} {qsys_mm.postTransform.pipelineCount} {1}
}
