...
# module rng_deskew
# 
set_module_property DESCRIPTION "Deskew the biased entropy input data using Von Neumann transition mapping technique."
set_module_property NAME rng_deskew
set_module_property VERSION 1.0
set_module_property INTERNAL false
set_module_property OPAQUE_ADDRESS_MAP true
set_module_property AUTHOR RSF
set_module_property DISPLAY_NAME rng_deskew
...
set_fileset_property QUARTUS_SYNTH TOP_LEVEL rng_deskew
set_fileset_property QUARTUS_SYNTH ENABLE_RELATIVE_INCLUDE_PATHS false
set_fileset_property QUARTUS_SYNTH ENABLE_FILE_OVERWRITE_MODE false
add_fileset_file rng_deskew.sv SYSTEM_VERILOG PATH rng_deskew.sv TOP_LEVEL_FILE

add_fileset SIM_VERILOG SIM_VERILOG "" ""
set_fileset_property SIM_VERILOG TOP_LEVEL rng_deskew
set_fileset_property SIM_VERILOG ENABLE_RELATIVE_INCLUDE_PATHS false
set_fileset_property SIM_VERILOG ENABLE_FILE_OVERWRITE_MODE false
add_fileset_file rng_deskew.sv SYSTEM_VERILOG PATH rng_deskew.sv

add_fileset SIM_VHDL SIM_VHDL "" ""
set_fileset_property SIM_VHDL TOP_LEVEL rng_deskew
...
add_interface_port sink snk_data data Input 2
...
add_interface_port source src_data data Output 1
