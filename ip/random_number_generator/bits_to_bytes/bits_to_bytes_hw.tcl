...
# 
set_module_property DESCRIPTION "Convert 1-bit symbols into 8-bit symbols."
set_module_property NAME bits_to_bytes
set_module_property VERSION 1.0
set_module_property INTERNAL false
set_module_property OPAQUE_ADDRESS_MAP true
set_module_property AUTHOR RSF
set_module_property DISPLAY_NAME bits_to_bytes
...
set_fileset_property QUARTUS_SYNTH TOP_LEVEL bits_to_bytes
set_fileset_property QUARTUS_SYNTH ENABLE_RELATIVE_INCLUDE_PATHS false
set_fileset_property QUARTUS_SYNTH ENABLE_FILE_OVERWRITE_MODE false
add_fileset_file bits_to_bytes.sv SYSTEM_VERILOG PATH bits_to_bytes.sv TOP_LEVEL_FILE

add_fileset SIM_VERILOG SIM_VERILOG "" ""
set_fileset_property SIM_VERILOG TOP_LEVEL bits_to_bytes
set_fileset_property SIM_VERILOG ENABLE_RELATIVE_INCLUDE_PATHS false
set_fileset_property SIM_VERILOG ENABLE_FILE_OVERWRITE_MODE false
add_fileset_file bits_to_bytes.sv SYSTEM_VERILOG PATH bits_to_bytes.sv

add_fileset SIM_VHDL SIM_VHDL "" ""
set_fileset_property SIM_VHDL TOP_LEVEL bits_to_bytes
